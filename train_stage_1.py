    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(net):
                ...
                masked_pixel_values = batch["img_maskd"].to(weight_dtype)
                mask_of_pixel_values = batch["img_mask"].to(weight_dtype)[:,0:1,:,:]
                ...
                with torch.no_grad():
                    ...
                    mask_of_latents = torch.nn.functional.interpolate(mask_of_pixel_values.unsqueeze(2), size=(mask_of_pixel_values.shape[-2] // 8, mask_of_pixel_values.shape[-1] // 8))   
