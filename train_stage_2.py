...
def main(cfg):
    ...
    denoising_unet.load_state_dict(
        torch.load(
            os.path.join("/home/qin/mycode/Pika-AnimateAnyone/pretrained_weights/motion_module.pth"),
            map_location="cpu",
        ),
        strict=False,
    )
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(net):
                ...
                masked_pixel_values = batch["pixel_values_vid_maskd"].to(weight_dtype)
                mask_of_pixel_values = batch["pixel_values_vid_mask"].to(weight_dtype)[:,:,0:1,:,:]
                ...
                with torch.no_grad():
                    ...
                    mask_of_latents = torch.nn.functional.interpolate(mask_of_pixel_values, size=(mask_of_pixel_values.shape[-2] // 8, mask_of_pixel_values.shape[-1] // 8))   
